...
export const ProductImport = () => {
    ...
    const arrayTh = ['Serie', 'Disponible', 'Tipo', 'Subtipo', 'Marca', 'Modelo', 'Estatus', 'Cliente'];
    ...
    const sendExcel = () => {
        ...
        axios.post(`${url}loadproduct`, f, configF)
            .then(res => {
                console.log(res);
                setFileR('');
                setShowImg(true);
            ...
            .catch(error => {
                ...
                if (error.response.status === 409 && error.response.data.status === 409 && error.response.data.message === 'La plantilla no coincide, debe tener las columnas: ["serie","disponible","tipo","subtipo","marca","modelo","estatus","cliente"], mas los extras.') {
        ...
        <>
            <div className="container animate__animated animate__fadeIn">
                <div className="row justify-content-center">
                    <h1 className="text-center mb-0 TitleIndex">Carga de Productos</h1>
