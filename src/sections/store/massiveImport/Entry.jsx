...
export const Entry = () => {
    ...
    const arrayTh = ['Serie', 'Origen', 'Cantidad', 'Cedis', 'Ubicacion', 'Seccion', 'Pasillo', 'Lugar'];
    ...
    const sendExcel = () => {
        ...
        axios.post(`${url}loadinventoryentries`, f, configF)
            .then(res => {
                console.log(res);
                setFileR('');
                setShowImg(true);
            ...
            .catch(error => {
                ...
                if (error.response.status === 409 && error.response.data.status === 409 && error.response.data.message === "La plantilla no coincide, debe tener las columnas: 'serie', 'origen', 'cantidad', 'cedis', 'ubicacion', 'seccion', 'pasillo', 'lugar'") {
        ...
        <>
            <div className="container animate__animated animate__fadeIn">
                <div className="row justify-content-center">
                    <h1 className="text-center mb-0 TitleIndex">Carga de Entradas</h1>
